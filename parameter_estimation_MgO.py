...
pickle.dump(s, open("src/ImpedancePy/shock_wave_compression/material_database/data/samplesMgO.p", "wb"))
...
s = pickle.load(open("src/ImpedancePy/shock_wave_compression/material_database/data/samplesMgO.p", "rb"))
